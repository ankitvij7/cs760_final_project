...
def vggish_inference(input_file, output_file):
    ...
    writer = tf.python_io.TFRecordWriter(output_file) if output_file else None

    with tf.Graph().as_default(), tf.Session() as sess:
        # Define the model in inference mode, load the checkpoint, and locate input and output tensors.
